...
public class ModulusApiTest extends BaseApiTest {

    @ParameterizedTest
    @CsvSource({"37.0,6.0","4.0,2.0"})
    void getModulusApi(Double num1, Double num2) {
        Formula formula = new Formula(num1, num2, Operation.MODULUS);
